...
axios.defaults.baseURL = 'https://www.xgqq.com/'
...
export default {
   ...
   */
  Login (params) {
    return fetch('/users/api/userLogin', qs.string(params))
  },
   ...
   */
  Regist (params) {
    return fetch('/users/api/userRegist', qs.string(params))
  },
  /**
   * 首页数据
   */
  homeList (params) {
    return fetch('front/current/platformAttribute', qs.string(params))
  },
